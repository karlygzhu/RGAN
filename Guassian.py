...
'''
   # Gaussian kernel for downsampling. This source file is originally from: https://github.com/junpan19/VSR_TGA
'''
...
def Guassian_downsample(x, scale=4):
    ...
    x = F.conv2d(x, gaussian_filter, stride=scale)           #此时改了步长，应用高斯噪声后的同时对图像进行了下采样
    #print(x.shape)
